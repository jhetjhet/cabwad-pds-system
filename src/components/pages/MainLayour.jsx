    ...
    return (
        <div className="flex">
            ...
            <div className="relative w-full flex flex-col h-screen overflow-y-hidden">
                ...
                <header className="w-full items-center bg-blue-400 py-2 px-6 hidden sm:flex">
                ...
                {/* <header className="w-full bg-sidebar py-5 px-6 sm:hidden bg-blue-500">
                    ...
                    <nav className="flex flex-col pt-4">
                        ...
                        <a href="forms.html" className="flex items-center active-nav-link text-white py-2 pl-4 nav-item">
